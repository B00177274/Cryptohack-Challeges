...
fn main() {
 let mut // Set to 1 on successful decryption
 ...
 let metadata = fs::metadata("flag.enc.png").unwrap(); // Total bytes to
...
fn get_encrypted_png() -> Vec<u8> {
 let file = fs::File::open("flag.enc.png").expect("Failed to open!");
